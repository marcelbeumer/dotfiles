...
_G.packer_plugins = {
  ...
  neoformat = {
    commands = { "Neoformat" },
    config = { "\27LJ\2\n¢\1\0\0\3\0\3\0\0056\0\0\0009\0\1\0'\2\2\0B\0\2\1K\0\1\0‚\1        let g:neoformat_enabled_typescript = ['denofmt']\n        let g:neoformat_enabled_typescriptreact = ['denofmt']\n      \bcmd\bvim\0" },
    loaded = false,
    needs_bufread = false,
  ...
  ["tokyonight.nvim"] = {
    config = { "\27LJ\2\n„\1\0\0\3\0\3\0\0056\0\0\0009\0\1\0'\2\2\0B\0\2\1K\0\1\0e        let g:tokyonight_italic_comments = 0\n        let g:tokyonight_italic_keywords = 0\n      \bcmd\bvim\0" },
    loaded = true,
  ...
  ["vim-vsnip"] = {
    config = { "\27LJ\2\n\2\0\0\3\0\3\0\0056\0\0\0009\0\1\0'\2\2\0B\0\2\1K\0\1\0í\1        let g:vsnip_filetypes = {}\n        let g:vsnip_filetypes.javascriptreact = ['javascript']\n        let g:vsnip_filetypes.typescriptreact = ['typescript']\n        let g:vsnip_snippet_dir = expand('~/.config/nvim/vsnip')\n      \bcmd\bvim\0" },
    loaded = true,
